...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name' => 'Editar usuarios'])->assignRole($role1, $role2, $role3);
        ...
        Permission::create(['name' => 'Ver publicacion'])->syncRoles([$role1, $role2, $role3]);
        Permission::create(['name' => 'Crear publicacion'])->assignRole($role2);
        Permission::create(['name' => 'Editar publicacion'])->assignRole($role2);
        Permission::create(['name' => 'Eliminar publicacion'])->syncRoles([$role1, $role2, $role3]);
        ...
        Permission::create(['name' => 'Editar comentario'])->syncRoles([$role1, $role2]);
